      ...
      <div class="dates dds__row" v-if="event.eventType == 0">
        <div class="dds__col--3 dds__col--sm-3">
          <div>
            ...
            <small class="warning" v-if="v$.event.startDate.$error">The Data field is required and it must be between the
              start and end date of the edition.</small>
          </div>
        </div>
        <div class="enddate dds__col--3 dds__col--sm-3">
          <div>
            ...
            <small class="warning" v-if="v$.event.endDate.$error">The Data field is required, it must be between the start
              and end date of the edition and cannot be before the actual start date of the event.</small>
          </div>
        </div>
      </div>
      <div class="enddate dds__col--3 dds__col--sm-3">
