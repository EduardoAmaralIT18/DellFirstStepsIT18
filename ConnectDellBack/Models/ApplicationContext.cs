    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EditionModel>().HasData(
            ...
            new {
                ...
                calendarEndDate = new DateTime(2023,05,29),
            ...
            new {
                ...
                calendarEndDate = new DateTime(2022,09,11),
            ...
            new {
                ...
                calendarEndDate = new DateTime(2024,02,29),
            ...
            new {
                ...
                calendarEndDate = new DateTime(2022,02,29),
        ...
        modelBuilder.Entity<EventsModel>().HasData(
            ...
            new {
                id = 8,
                editionid = 1,
                name = "Meeting with Rafael Astrana",
            ...
            new {
                id = 9,
                editionid = 1,
                name = "Meeting with Valdomiro Rischtter",
            ...
            new {
                id = 11,
                editionid = 1,
                name = "Meeting with Cristina Camacho",
            ...
            new {
                id = 12,
                editionid = 1,
                name = "Meeting with Rogerio Kunkel",
