<template>
  <div
    id="text-area-container-502168065"
    class="dds__text-area__container"
    data-dds="text-area"
  >
    <div class="dds__text-area__header">
      <label
        v-if="required"
        id="text-area-label-867784391"
        for="text-area-control-867784391"
    ...
    <div class="dds__text-area__wrapper">
      <textarea
        ...
        name="text-area-control-name-867784391"
        id="text-area-control-867784391"
        aria-required="true"
      ...
      <small id="text-area-error-867784391" class="dds__invalid-feedback">{{
        errorText
      }}</small>
    </div>
  </div>
