  ...
  >
    <section class="dds__side-nav">
      <ul class="dds__side-nav__menu">
        <li
          @click="handleClick(1)"
          :class="{ 'dds__side-nav__item--selected': isActive === 1 }"
          class="dds__side-nav__item"
        >
          <a href="javascript:void(0)">
            <span
              class="text dds__icon dds__side-nav__icon dds__icon--home"
              aria-hidden="true"
            ></span>
        ...
        <li
          @click="handleClick(2)"
          :class="{ 'dds__side-nav__item--selected': isActive === 2 }"
          v-if="role === 0"
          class="dds__side-nav__item"
        >
          <a href="javascript:void(0)">
            <span
              class="text dds__icon dds__side-nav__icon dds__icon--user-cir"
              aria-hidden="true"
            ></span>
